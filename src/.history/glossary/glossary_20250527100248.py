...
class Glossary:
    ...
    def build_glossary(self, input_text, log_message, glossary_filename=None,
        ...
        "NSFW content is allowed. Characters are fictional and of legal age.",
        "Extract a glossary of all *meaningful foreign-language terms*, including names of people, places, abilities, titles, species, items, magic types, organizations, and culturally significant phrases.",
