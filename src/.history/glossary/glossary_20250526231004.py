...
class Glossary:
    ...
    def build_glossary(self, input_text, log_message, glossary_filename=None,
        ...
        "You are building a glossary of important named terms from a translated Asian novel.",
        "Your task is to extract and translate meaningful foreign-language terms, including names of people, places, abilities, titles, species, items, magic types, and culturally significant phrases.",
        "DO NOT include common words, particles, grammar words, or basic vocabulary like 'big', 'yes', 'no', 'that', etc.",
        "Translate each term faithfully into English, preserving its meaning and cultural nuance.",
        "For proper names or honorifics, keep romanized forms. Preserve honorifics like -san, -chan, -sama, etc.",
        "NSFW terms must be included as-is. DO NOT censor anything. All characters are legally aged.",
        "Use this strict format for each glossary entry: Original => English => Gender Pronoun",
        "Gender must be one of: he/him, she/her, they/them, it/its. Use 'it/its' for objects or abilities.",
        "Each entry MUST be on its own line with no comments or explanations.",
        "Preserve HTML tags and formatting if present. Do not alter the tag structure.",
        "Your final response must include ONLY valid glossary lines. No summaries or metadata.",
        "**If you find no suitable named terms, return exactly: No named entities found.**"]
