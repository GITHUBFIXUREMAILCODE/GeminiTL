...
def replace_image_tags_with_ocr(text, image_dir, log_function=print):
    """
    ...
    def replacer(match):
        ...
        if not os.path.exists(image_path):
            ...
            log_function(f"[REPLACED] Missing Image: {image_name} -> Embedded Image")
            return replacement
        ...
        log_function(f"[REPLACED] OCR Failed: {image_name} -> Embedded Image")
        return replacement  
